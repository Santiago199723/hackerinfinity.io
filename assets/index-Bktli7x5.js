...
{ symbol: "TRX/USD-OTC", name: "TRXUSD-OTC", category: "FOREX_OTC" },
{ symbol: "UNI/USD-OTC", name: "UNIUSD-OTC", category: "FOREX_OTC" },
{ symbol: "VET/USD-OTC", name: "VETUSD-OTC", category: "FOREX_OTC" },
{ symbol: "XLM/USD-OTC", name: "XLMUSD-OTC", category: "FOREX_OTC" },
{ symbol: "XRPUSD", name: "XRP/USD-OTC", category: "FOREX_OTC" },
{ symbol: "ETH/USD (Drax)", name: "ETHUSD", category: "FOREX_OTC" },
{ symbol: "BNB/USD-OTC", name: "BNBUSD-OTC", category: "FOREX_OTC" },
{ symbol: "BTC/USD (Drax)", name: "BTCUSD", category: "FOREX_OTC" },
{ symbol: "BTC/USD-OTC", name: "BTCUSD-OTC", category: "FOREX_OTC" },
{ symbol: "DOGE/USD-OTC", name: "DOGEUSD-OTC", category: "FOREX_OTC" },
{ symbol: "DOT/USD-OTC", name: "DOTUSD-OTC", category: "FOREX_OTC" },
{ symbol: "ETC/USD-OTC", name: "ETCUSD-OTC", category: "FOREX_OTC" },
{ symbol: "ADAUSD", name: "ADA/USD-OTC", category: "FOREX_OTC" },
{ symbol: "APT/USD-OTC", name: "APTUSD-OTC", category: "FOREX_OTC" },
{ symbol: "ARB/USD-OTC", name: "ARBUSD-OTC", category: "FOREX_OTC" },
{ symbol: "ATOM/USD-OTC", name: "ATOMUSD-OTC", category: "FOREX_OTC" },
{ symbol: "AVAX/USD-OTC", name: "AVAXUSD-OTC", category: "FOREX_OTC" },
{ symbol: "BCHUSD", name: "BCH/USD", category: "FOREX_OTC" }]
...
, vs = () => {
    ...
    , zj = ({ selectedAsset: e, onAssetSelect: t, broker: B = "" }) => {
        ...
        const checkDrax = () => {
            try {
                if (B && B.toLowerCase().includes("drax")) return !0;
                const estadoGlobal = typeof gs === "function" ? gs() : {};
                if (estadoGlobal && estadoGlobal.broker && estadoGlobal.broker.toLowerCase().includes("drax")) return !0;
                const lsBroker = localStorage.getItem("selectedBroker") || localStorage.getItem("broker") || "";
                if (lsBroker.toLowerCase().includes("drax")) return !0;
            } catch (err) {}
            return !1;
        };
        const isDrax = checkDrax();

        const [n, r] = x.useState(!1)
            , [s, i] = x.useState("FOREX_OTC")
            , [o, l] = x.useState("")
            , { t: u } = ue()
            , c = [{
                value: "FOREX",
            ...
            , todosAtivos = isDrax ? draxAssets : (typeof Zu !== "undefined" ? Zu : [])
            , d = todosAtivos.filter(h => h.category === s).filter(h => o === "" || h.symbol.toLowerCase().includes(o.toLowerCase()) || h.name.toLowerCase().includes(o.toLowerCase()))
