...
const Zu = [
      ...
      // ==========================================
      // ABA 2: OTC (category: "FOREX_OTC")
      // Todos os ativos com OTC precisam desta categoria para aparecer na aba correta
      // ==========================================
      {
        symbol: "EUR/USD OTC",
        ...
        symbol: "TRX/USD OTC",
        name: "TRON/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      }, {
        symbol: "UNI/USD OTC",
        name: "Uniswap/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      }, {
        symbol: "VET/USD OTC",
        name: "VeChain/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      }, {
        symbol: "XLM/USD OTC",
        name: "Stellar/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      }, {
        symbol: "XRP/USD OTC",
        name: "Ripple/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      }, {
        symbol: "BNB/USD OTC",
        name: "Binance Coin/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      }, {
        symbol: "BTC/USD OTC",
        ...
        symbol: "DOGE/USD OTC",
        name: "Dogecoin/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      }, {
        symbol: "DOT/USD OTC",
        name: "Polkadot/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      }, {
        symbol: "ETC/USD OTC",
        name: "Ethereum Classic/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      }, {
        symbol: "ADA/USD OTC",
        name: "Cardano/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      }, {
        symbol: "APT/USD OTC",
        name: "Aptos/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      }, {
        symbol: "ARB/USD OTC",
        name: "Arbitrum/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      }, {
        symbol: "ATOM/USD OTC",
        name: "Cosmos/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      }, {
        symbol: "AVAX/USD OTC",
        name: "Avalanche/US Dollar OTC",
        category: "FOREX_OTC",
        icon: "Ws"
      },

      // ==========================================
      // ABA 3: CRYPTO (category: "CRYPTO")
      // Apenas ativos Cripto padrão, sem OTC
      // ==========================================
      {
        symbol: "TRUMP/USD",
