...
, vs = () => {
    ...
    , zj = ({ selectedAsset: e, onAssetSelect: t, broker: B = "" }) => {
        ...
        // Ativos listados nos prints da Drax, categorizados rigidamente como FOREX_OTC
        const draxAssets = [
            ...
            { symbol: "ETH/USD", name: "ETHUSD", category: "FOREX_OTC" },
            { symbol: "BNB/USD-OTC", name: "BNBUSD-OTC", category: "FOREX_OTC" },
            { symbol: "BTC/USD", name: "BTCUSD", category: "FOREX_OTC" },
        ...
        const [n, r] = x.useState(!1)
            ...
            // Aqui a mágica: Ignora a Zu global se a corretora tiver "drax" no nome (independente se for maiusculo/minúsculo)
            , todosAtivos = (B || "").toLowerCase().includes("drax") ? draxAssets : (typeof Zu !== "undefined" ? Zu : [])
