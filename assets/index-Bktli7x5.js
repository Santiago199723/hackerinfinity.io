...
, vs = () => {
    ...
    , zj = ({ selectedAsset: e, onAssetSelect: t, broker: B = "" }) => {
        ...
        // Ativos listados nas imagens, categorizados como FOREX_OTC para aparecerem na aba correta
        const draxAssets = [
        ...
        const [n, r] = x.useState(!1)
            // Define FOREX_OTC como a aba padrão para todas as escolhas, incluindo a Drax
            ...
            // Se for draxoption, substitui a lista inteira por draxAssets. Se não, usa a Zu.
            , todosAtivos = B === "draxoption" ? draxAssets : (typeof Zu !== "undefined" ? Zu : [])
