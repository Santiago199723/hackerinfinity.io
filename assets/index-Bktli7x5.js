...
const Zu = [
      ...
      // ==========================================
      // ABA 2: OTC (Tudo que tem OTC vai aqui para o meio)
      // ==========================================
      ...
      { symbol: "Cripto/IDX OTC", name: "Cripto/IDX", category: "FOREX_OTC", flag1: "🇨🇷", flag2: "🇮🇩" },
      ...
      { symbol: "BTC/USD", name: "Bitcoin/US Dollar", category: "CRYPTO", icon: "dj" },
      { symbol: "ETH/USD", name: "Ethereum/US Dollar", category: "CRYPTO", icon: "Lj" },
      { symbol: "BNB/USD", name: "Binance Coin/US Dollar", category: "CRYPTO", icon: "Ws" },
      { symbol: "XRP/USD", name: "Ripple/US Dollar", category: "CRYPTO", icon: "Ws" },
      { symbol: "ADA/USD", name: "Cardano/US Dollar", category: "CRYPTO", icon: "Ws" },
      { symbol: "SOL/USD", name: "Solana/US Dollar", category: "CRYPTO", icon: "Ws" },
      { symbol: "BCH/USD", name: "Bitcoin Cash/US Dollar", category: "CRYPTO", icon: "Ws" }
    ]
, vs = () => {
    const e = rr()
        , { t } = ue()
