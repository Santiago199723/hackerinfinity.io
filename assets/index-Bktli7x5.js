...
, vs = () => {
    ...
    , zj = ({ selectedAsset: e, onAssetSelect: t, broker: B = "" }) => {
        ...
        // Novos ativos da corretora Draxoption baseados na imagem
        const draxAssets = [
            { symbol: "TRX/USD-OTC", name: "TRXUSD-OTC", category: "CRYPTO" },
            { symbol: "UNI/USD-OTC", name: "UNIUSD-OTC", category: "CRYPTO" },
            { symbol: "VET/USD-OTC", name: "VETUSD-OTC", category: "CRYPTO" },
            { symbol: "XLM/USD-OTC", name: "XLMUSD-OTC", category: "CRYPTO" },
            { symbol: "XRPUSD", name: "XRP/USD-OTC", category: "CRYPTO" },
            { symbol: "ETH/USD", name: "ETHUSD", category: "CRYPTO" },
            { symbol: "BNB/USD-OTC", name: "BNBUSD-OTC", category: "CRYPTO" },
            { symbol: "BTC/USD", name: "BTCUSD", category: "CRYPTO" },
            { symbol: "BTC/USD-OTC", name: "BTCUSD-OTC", category: "CRYPTO" },
            { symbol: "DOGE/USD-OTC", name: "DOGEUSD-OTC", category: "CRYPTO" },
            { symbol: "DOT/USD-OTC", name: "DOTUSD-OTC", category: "CRYPTO" },
            { symbol: "ETC/USD-OTC", name: "ETCUSD-OTC", category: "CRYPTO" },
            { symbol: "ADAUSD", name: "ADA/USD-OTC", category: "CRYPTO" },
            { symbol: "APT/USD-OTC", name: "APTUSD-OTC", category: "CRYPTO" },
            { symbol: "ARB/USD-OTC", name: "ARBUSD-OTC", category: "CRYPTO" },
            { symbol: "ATOM/USD-OTC", name: "ATOMUSD-OTC", category: "CRYPTO" },
            { symbol: "AVAX/USD-OTC", name: "AVAXUSD-OTC", category: "CRYPTO" },
            { symbol: "BCHUSD", name: "BCH/USD", category: "CRYPTO" }
        ];

        const [n, r] = x.useState(!1)
            // Se for draxoption, inicia com CRYPTO, caso contrário inicia com FOREX_OTC
            , [s, i] = x.useState(B === "draxoption" ? "CRYPTO" : "FOREX_OTC")
            , [o, l] = x.useState("")
            , { t: u } = ue()
            , c = [{
                value: "FOREX",
            ...
            // Combina os ativos padrões (Zu) com os da Draxoption caso a corretora seja ela
            , todosAtivos = B === "draxoption" ? [...(typeof Zu !== "undefined" ? Zu : []), ...draxAssets] : (typeof Zu !== "undefined" ? Zu : [])
